...
try:
    ...
    # Extract features
    attack = int(input_data.get('attack', 0))
    count = float(input_data.get('count', 0))
    dst_host_diff_srv_rate = float(input_data.get('dst_host_diff_srv_rate', 0))
    dst_host_same_src_port_rate = float(input_data.get('dst_host_same_src_port_rate', 0))
    dst_host_same_srv_rate = float(input_data.get('dst_host_same_srv_rate', 0))
    dst_host_srv_count = float(input_data.get('dst_host_srv_count', 0))
    flag = int(input_data.get('flag', 0))
    last_flag = float(input_data.get('last_flag', 0))
    logged_in = int(input_data.get('logged_in', 0))
    same_srv_rate = float(input_data.get('same_srv_rate', 0))
    serror_rate = float(input_data.get('serror_rate', 0))
    service_http = int(input_data.get('service_http', 0))
